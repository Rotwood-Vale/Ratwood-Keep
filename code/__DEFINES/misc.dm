...
#define CLOAK_BEHIND_LAYER		41
#define HANDS_BEHIND_LAYER		41
#define BELT_BEHIND_LAYER		39
#define BACK_BEHIND_LAYER		38
#define BODY_BEHIND_LAYER		37		//certain mutantrace features (tail when looking south) that must appear behind the body parts
#define BODY_UNDER_LAYER		36		// Things under the bodyparts but above the "behind body" layer
...
#define LEG_PART_LAYER			30
#define PANTS_LAYER				29
#define SHOES_LAYER				28
#define LEG_DAMAGE_LAYER		27
#define SHIRT_LAYER				26
#define WRISTS_LAYER			25
#define ARMOR_LAYER				24
#define TABARD_LAYER			23
#define BELT_LAYER				22		//only when looking south
#define UNDER_CLOAK_LAYER		21
