...
#define ALL_RACES_LIST		list("human", "dwarf", "elf", "tiefling", "aasimar", "lizardfolk", "tabaxi")

#define ALL_RACES_LIST_NAMES		list("Humen", "Humen", "Half-Elf", "Elf", "Elf", "Dwarf","Dwarf","Tiefling", "Aasimar", "Lizardfolk", "Tabaxi")
