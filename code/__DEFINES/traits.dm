...
#define TRAIT_MIRACLE_IMMUNE "Miracle Immune" //Makes you entirely immune to all forms of miracles!
...
GLOBAL_LIST_INIT(roguetraits, list(
	...
	TRAIT_MIRACLE_IMMUNE = "Your patron protects you from Miracles.",
