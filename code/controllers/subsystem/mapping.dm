...
/datum/controller/subsystem/mapping/proc/spawn_random_travel_tiles()
	spawn_random_travel_transition("vampexit", "vampin")
	spawn_random_travel_transition("banditexit", "banditin")

/datum/controller/subsystem/mapping/proc/spawn_random_travel_transition(travel_id, travel_goes_to_id)
	...
	if(!location)
		...
		return
	create_travel_tiles(location, travel_id, travel_goes_to_id)
