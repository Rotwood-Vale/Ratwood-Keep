...
/datum/patron/inhumen/graggar
	...
	mob_traits = list(TRAIT_ORGAN_EATER, TRAIT_INHUMMEN_FOLLOWER) // allows you to eat organs
	confess_lines = list(
...
/datum/patron/inhumen/matthios 
	...
	mob_traits = list(TRAIT_MATTHIOS_EYES, TRAIT_INHUMMEN_FOLLOWER) // shows most expensive item
	confess_lines = list(
...
/datum/patron/inhumen/baotha
    ...
    mob_traits = list(TRAIT_CRACKHEAD, TRAIT_INHUMMEN_FOLLOWER) // prevents overdoses
    confess_lines = list(
