...
/datum/outfit/job/roguetown/slaver/master/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/clothing/neck/roguetown/gorget/prisoner = 2, /obj/item/reagent_containers/glass/bottle/rogue/healthpot = 1)
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/craft/medicine, 2, TRUE)
...
/datum/outfit/job/roguetown/slaver/slavemercsword/pre_equip(mob/living/carbon/human/H)
	...
	belt = /obj/item/storage/belt/rogue/shalal
	armor = /obj/item/clothing/suit/roguetown/armor/plate/scale
	backl = /obj/item/storage/backpack/rogue/satchel
	backr = /obj/item/rogueweapon/sword/long/rider
	beltl = /obj/item/storage/belt/rogue/pouch/coins/poor 
	backpack_contents = list(/obj/item/rope/chain = 1, /obj/item/rogueweapon/huntingknife/idagger)
	if(H.mind)
