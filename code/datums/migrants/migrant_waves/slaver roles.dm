...
/datum/outfit/job/roguetown/slaver/master/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/reagent_containers/glass/bottle/rogue/healthpot = 2, /obj/item/rope/chain = 1, /obj/item/flint = 1, /obj/item/clothing/neck/roguetown/collar/leather/cursed = 2, /obj/item/leash/chain = 3)
	if(H.mind)
