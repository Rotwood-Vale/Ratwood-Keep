...
/datum/status_effect/buff/drunk
	...
	effectedstats = list(STAT_STRING_INT = -2, STAT_STRING_END = 1)
	duration = 5 MINUTES
...
/datum/status_effect/buff/greatsnackbuff
	...
	effectedstats = list(STAT_STRING_CON = 1,STAT_STRING_END = 1)
	duration = 10 MINUTES
...
/datum/status_effect/buff/sweet
	...
	effectedstats = list(STAT_STRING_LUC = 1)
	duration = 8 MINUTES
...
/datum/status_effect/buff/druqks
	...
	effectedstats = list(STAT_STRING_INT,STAT_STRING_SPD = 3,STAT_STRING_LUC = -5)
	duration = 10 SECONDS
...
/datum/status_effect/buff/eoradruqks
	id = "druqks"
	alert_type = /atom/movable/screen/alert/status_effect/buff/druqks
	effectedstats = list(STAT_STRING_SPD = -3,STAT_STRING_LUC = -5, STAT_STRING_CON = -2)
	duration = 20 SECONDS
...
/datum/status_effect/buff/ozium
	id = "ozium"
	alert_type = /atom/movable/screen/alert/status_effect/buff/druqks
	effectedstats = list(STAT_STRING_SPD = -5, STAT_STRING_PER = 2)
	duration = 30 SECONDS
...
/datum/status_effect/buff/moondust
	id = "moondust"
	alert_type = /atom/movable/screen/alert/status_effect/buff/druqks
	effectedstats = list(STAT_STRING_SPD = 4, STAT_STRING_END = 4, STAT_STRING_PER = -3)
	duration = 30 SECONDS
...
/datum/status_effect/buff/moondust_purest
	id = "purest moondust"
	alert_type = /atom/movable/screen/alert/status_effect/buff/druqks
	effectedstats = list(STAT_STRING_SPD = 5, STAT_STRING_END = 5, STAT_STRING_PER = -2)
	duration = 40 SECONDS
...
/datum/status_effect/buff/weed
	...
	effectedstats = list(STAT_STRING_INT,STAT_STRING_SPD = -2,STAT_STRING_LUC = 2)
	duration = 10 SECONDS
...
/datum/status_effect/buff/haste
	...
	effectedstats = list(STAT_STRING_SPD = 3)
	duration = 1.5 MINUTES

/datum/status_effect/buff/seelie_drugs
	id = "seelie drugs"
	alert_type = /atom/movable/screen/alert/status_effect/buff/druqks
	effectedstats = list(STAT_STRING_INT, STAT_STRING_END = 4, STAT_STRING_SPD = -3)
	duration = 20 SECONDS
...
/datum/status_effect/buff/magicknowledge
	...
	effectedstats = list(STAT_STRING_INT)
	duration = 10 MINUTES
...
/datum/status_effect/buff/magicstrength
	...
	effectedstats = list(STAT_STRING_STR = 3)
	duration = 20 MINUTES
...
/datum/status_effect/buff/magicstrength/lesser
	...
	effectedstats = list(STAT_STRING_STR = 1)
	duration = 20 MINUTES
...
/datum/status_effect/buff/magicendurance
	...
	effectedstats = list(STAT_STRING_END = 3)
	duration = 20 MINUTES
...
/datum/status_effect/buff/magicconstitution
	...
	effectedstats = list(STAT_STRING_CON = 3)
	duration = 20 MINUTES
...
/datum/status_effect/buff/magicperception
	...
	effectedstats = list(STAT_STRING_PER = 3)
	duration = 20 MINUTES
...
/datum/status_effect/buff/greatermanabuff
	...
	effectedstats = list(STAT_STRING_SPD = 2, STAT_STRING_INT)
	duration = 20 SECONDS
...
/datum/status_effect/buff/sermon
	...
	effectedstats = list(STAT_STRING_LUC = 1, STAT_STRING_CON = 1)
	duration = 20 MINUTES
...
/datum/status_effect/buff/gazeuponme
	...
	effectedstats = list(STAT_STRING_SPD = 1, STAT_STRING_INT)
...
/datum/status_effect/buff/royalmeat
	...
	effectedstats = list(STAT_STRING_LUC = 3)
	duration = -1 // permanent
