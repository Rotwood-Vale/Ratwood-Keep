...
GLOBAL_LIST_INIT(slots, list("head", "wear_mask", "back", "wear_armor", "wear_pants", "shoes", "belt", "gloves", "glasses", "ears", "wear_ring", "wear_wrists", "s_store"))
GLOBAL_LIST_INIT(slot2slot, list("head" = SLOT_HEAD, "wear_mask" = SLOT_WEAR_MASK, "neck" = SLOT_NECK, "back" = SLOT_BACK, "wear_armor" = SLOT_ARMOR, "wear_pants" = SLOT_PANTS, "shoes" = SLOT_SHOES, "belt" = SLOT_BELT, "gloves" = SLOT_GLOVES, "glasses" = SLOT_GLASSES, "ears" = SLOT_HEAD, "wear_ring" = SLOT_RING, "s_store" = SLOT_S_STORE))
GLOBAL_LIST_INIT(slot2type, list("head" = /obj/item/clothing/head/changeling, "wear_mask" = /obj/item/clothing/mask/changeling, "back" = /obj/item/changeling, "wear_armor" = /obj/item/clothing/suit/changeling, "wear_pants" = /obj/item/clothing/under/changeling, "shoes" = /obj/item/clothing/shoes/changeling, "belt" = /obj/item/changeling, "gloves" = /obj/item/clothing/gloves/changeling, "glasses" = /obj/item/clothing/glasses/changeling, "ears" = /obj/item/changeling, "wear_ring" = /obj/item/changeling, "s_store" = /obj/item/changeling))
