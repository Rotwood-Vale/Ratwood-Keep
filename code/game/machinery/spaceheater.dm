...
/obj/machinery/space_heater/attackby(obj/item/I, mob/user, params)
	...
	if(istype(I, /obj/item/stock_parts/cell))
		if(panel_open)
			...
			user.visible_message(span_notice("\The [user] inserts a power cell into \the [src]."), span_notice("I insert the power cell into \the [src]."))
		...
		user.visible_message(span_notice("\The [user] [panel_open ? "opens" : "closes"] the hatch on \the [src]."), span_notice("I [panel_open ? "open" : "close"] the hatch on \the [src]."))
		update_icon()
