...
/obj/item/natural/sylvanessence	//T4 mage summon loot
	...
	desc = "A solid chunk of... something, said to be part of a sylvan's soul."
	resistance_flags = FLAMMABLE
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/natural/elementalmote
	name = "elemental mote"
	icon_state = "mote"
	desc = "A mote of elemental, left behind. Small, yet glowing with arcana."
	resistance_flags = FLAMMABLE
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/natural/elementalshard
	...
	icon_state = "shard"
	desc = "A torn shard of an elemental. Fitting within one hand, it gives off an arcyne glow."
	resistance_flags = FLAMMABLE
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/natural/elementalfragment
	...
	icon_state = "fragment"
	desc = "A chunk of an elemental, it thrumbs with arcyne power."
	resistance_flags = FLAMMABLE
	w_class = WEIGHT_CLASS_SMALL
...
/obj/item/natural/elementalrelic
	...
	icon_state = "relic"
	desc = "A huge piece of a powerful elemental. it shines brightly with arcyne power."
	resistance_flags = FLAMMABLE
	w_class = WEIGHT_CLASS_SMALL
