...
//Javelins - not technically a 'polearm' but they're spear-like.
/obj/item/rogueweapon/spear/javelin
	force = 14
	force_wielded = 14	//No extra
	throw_speed = 4
	name = "iron javelin"
	...
	icon_state = "ijavelin"
	icon = 'icons/roguetown/weapons/32.dmi'	//Smaller than spear sprite
	bigboy = FALSE	//Can be one-handed cus' it's a javelin.
	gripsprite = TRUE
	wlength = WLENGTH_LONG
	w_class = WEIGHT_CLASS_BULKY
	minstr = 6	//It’s not that heavy or big.
...
/obj/item/rogueweapon/spear/javelin/steel
	force = 18
	force_wielded = 18	//No extra
	name = "steel javelin"
...
/obj/item/rogueweapon/spear/javelin/steel/silver
	name = "silver javelin"
...
//Snowflake code to make sure the silver-bane is applied on hit to targeted mob.
/obj/item/rogueweapon/spear/javelin/steel/silver/throw_impact(atom/hit_atom, datum/thrownthing/throwingdatum)
