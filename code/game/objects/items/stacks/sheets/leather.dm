...
/obj/item/stack/sheet/animalhide/attackby(obj/item/W, mob/user, params)
	if(W.get_sharpness())
		...
		user.visible_message(span_notice("[user] starts cutting hair off \the [src]."), span_notice("I start cutting the hair off \the [src]..."), span_hear("I hear the sound of a knife rubbing against flesh."))
...
/obj/item/stack/sheet/wetleather/heating_act()
	..()
