		...
		if(istype(attachment, /obj/item/cooking/pan))
			if(W.type in subtypesof(/obj/item/reagent_containers/food/snacks))
				...
				if(!food)
					...
					return
		// I don't know why the pot was changed in reagent size but thes values need to reflect it
		// If 3 things should fill a pot and a pot is now a value of 300, these should be doing 100 at the least.
			...
			if(istype(W, /obj/item/reagent_containers/food/snacks/grown/oat))
				if(!pot.reagents.has_reagent(/datum/reagent/water, 100))
				...
				if(do_after(user,2 SECONDS, target = src))
					...
					pot.reagents.remove_reagent(/datum/reagent/water, 99)
					sleep(300)
					playsound(src, "bubbles", 30, TRUE)
					pot.reagents.add_reagent(/datum/reagent/consumable/soup/oatmeal, 100)
			...
			if(W.type in subtypesof(/obj/item/reagent_containers/food/snacks/rogue/veg))
				...
				if(do_after(user,2 SECONDS, target = src))
					...
					if(istype(W, /obj/item/reagent_containers/food/snacks/rogue/veg/potato_sliced))
						...
						sleep(800)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/veggie/potato, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
					if(istype(W, /obj/item/reagent_containers/food/snacks/rogue/veg/onion_sliced))
						qdel(W)
						sleep(600)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/veggie/onion, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
					if(istype(W, /obj/item/reagent_containers/food/snacks/grown/beet))
						qdel(W)
						sleep(600)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/veggie/beet, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
					if(istype(W, /obj/item/reagent_containers/food/snacks/rogue/veg/cabbage_sliced))
						qdel(W)
						sleep(700)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/veggie/cabbage, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
				return
			...
			if(W.type in subtypesof(/obj/item/reagent_containers/food/snacks/rogue/meat))
				...
				if(do_after(user,2 SECONDS, target = src))
					...
					if(istype(W, /obj/item/reagent_containers/food/snacks/rogue/meat/mince/fish))
						...
						sleep(800)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/stew/fish, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
					if(istype(W, /obj/item/reagent_containers/food/snacks/rogue/meat/spider))
						qdel(W)
						sleep(1000)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/stew/yucky, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
					if(istype(W, /obj/item/reagent_containers/food/snacks/rogue/meat/poultry/cutlet) || istype(W, /obj/item/reagent_containers/food/snacks/rogue/meat/mince/poultry))
						...
						sleep(900)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/stew/chicken, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
					else
						qdel(W)
						sleep(900)
						playsound(src, "bubbles", 30, TRUE)
						pot.reagents.add_reagent(/datum/reagent/consumable/soup/stew/meat, 100)
						pot.reagents.remove_reagent(/datum/reagent/water, 1)
				return
	. = ..()
