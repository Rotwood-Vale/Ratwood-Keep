...
/datum/antagonist/changeling/proc/readapt()
	...
	if(canrespec)
		...
		to_chat(owner.current, span_warning("I lack the power to readapt your evolutions!"))
		return 0
...
/datum/antagonist/changeling/farewell()
	to_chat(owner.current, span_danger("I grow weak and lose your powers! You are no longer a changeling and are stuck in your current form!"))
