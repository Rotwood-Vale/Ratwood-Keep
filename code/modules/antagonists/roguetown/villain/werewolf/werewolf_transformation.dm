...
//	stop_cmusic()
	...
	W.adjust_skillrank(/datum/skill/misc/sneaking, 2, TRUE)
	W.adjust_skillrank(/datum/skill/misc/swimming, 3, TRUE)
	W.adjust_skillrank(/datum/skill/misc/athletics, 4, TRUE)
