...
//			REMOVE_TRAIT(zombie, trait, "[type]")
		REMOVE_TRAIT(zombie, TRAIT_NOMOOD, TRAIT_GENERIC)	//Start temporary longform trait removal- Please refractor this to remove via an entire list, please.
		REMOVE_TRAIT(zombie, TRAIT_NOHUNGER, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_EASYDISMEMBER, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_NOBREATH, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_TOXIMMUNE, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_CHUNKYFINGERS, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_NOSLEEP, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_BASHDOORS, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_SPELLCOCKBLOCK, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_BLOODLOSS_IMMUNE, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_LIMPDICK, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_ZOMBIE_SPEECH, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_ZOMBIE_IMMUNE, TRAIT_GENERIC)
		REMOVE_TRAIT(zombie, TRAIT_NORUN, TRAIT_GENERIC)	//end temporary longform trait removal
