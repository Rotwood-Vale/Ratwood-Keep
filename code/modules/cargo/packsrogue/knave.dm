...
/datum/supply_pack/rogue/bandit/Knave
	group = "Knave"
...
/datum/supply_pack/rogue/bandit/Knave/leather/elfdagger
	name = "Elven Dagger"
	cost = 250
...
/datum/supply_pack/rogue/bandit/Knave/heater
	name = "Heater Shield"
	cost = 150
	contains = list(/obj/item/rogueweapon/shield/heater)

/datum/supply_pack/rogue/bandit/Knave/crossbow
	name = "Crossbow"
	cost = 100
