...
/datum/preferences/proc/SetChoices(mob/user, limit = 15, list/splitJobs = list("Court Magos", "Retinue Captain", "Priest", "Merchant", "Archivist", "Towner", "Beggar", "Prisoner", "Goblin King"), widthPerColumn = 295, height = 670) //295 620
	if(!SSjob)
		return
