...
/obj/item/clothing/suit/roguetown/armor/leather/cult_robe
	name = "cultist robes"
	desc = "Strange robes emblazoned with even stranger sigils and characters."
	icon_state = "warlock"
	item_state = "warlock"
...
/obj/item/clothing/suit/roguetown/armor/leather/cult_robe/empowered
	name = "cultist robes"
	desc = "These strange robes thrum with an eery, profane energy."
	icon_state = "ewarlock"
	item_state = "ewarlock"
	max_integrity = 250
