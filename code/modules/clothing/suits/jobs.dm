...
/obj/item/clothing/suit/det_suit
	...
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("blunt" = 45, "slash" = 25, "stab" = 35, "bullet" = 10, "laser" = 25, "energy" = 35, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 45)
...
/obj/item/clothing/suit/curator
	...
	armor = list("blunt" = 55, "slash" = 35, "stab" = 45, "bullet" = 10, "laser" = 25, "energy" = 35, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 45)
