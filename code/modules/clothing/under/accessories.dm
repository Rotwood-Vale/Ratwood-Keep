...
/obj/item/clothing/accessory/medal/plasma/temperature_expose(datum/gas_mixture/air, exposed_temperature, exposed_volume)
	if(exposed_temperature > 300)
		...
		visible_message(span_danger("\The [src] bursts into flame!"), span_danger("My [src] bursts into flame!"))
		qdel(src)
...
/obj/item/clothing/accessory/lawyers_badge/attack_self(mob/user)
	...
	user.visible_message(span_notice("[user] shows [user.p_their()] attorney's badge."), span_notice("I show my attorney's badge."))
