...
/datum/crafting_recipe/roguetown/shrmzig
	name = "shroom zig"
	result = /obj/item/clothing/mask/cigarette/rollie/shroom
	reqs = list(/obj/item/reagent_containers/food/snacks/grown/rogue/shroomdry = 1,
				/obj/item/paper/scroll = 1)
	req_table = TRUE
	time = 10 SECONDS
	verbage_simple = "roll"
...
/datum/crafting_recipe/roguetown/dryshroom
	name = "pipe filler"
	result = /obj/item/reagent_containers/food/snacks/grown/rogue/duddry
...
/datum/crafting_recipe/roguetown/flffzig
	name = "herbal zig"
	result = /obj/item/clothing/mask/cigarette/rollie/dud
	reqs = list(/obj/item/reagent_containers/food/snacks/grown/rogue/duddry = 1,
				/obj/item/paper/scroll = 1)
	req_table = TRUE
	time = 10 SECONDS
	verbage_simple = "roll"
