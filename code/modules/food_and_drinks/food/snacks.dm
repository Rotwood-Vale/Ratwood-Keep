...
/obj/item/reagent_containers/food/snacks/process()
	..()
	if(rotprocess)
		if(!istype(loc, /obj/structure/closet/crate/chest) && ! istype(loc, /obj/item/cooking/platter)  && !istype(loc, /obj/structure/roguemachine/vendor) && !istype (loc, /obj/structure/table/cooling))
