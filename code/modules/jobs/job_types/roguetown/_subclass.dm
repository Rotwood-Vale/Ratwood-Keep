...
/datum/subclass/proc/equipme(mob/living/carbon/human/H)
	// input sleeps....
	set waitfor = FALSE
	if(!H)
		return FALSE
...
/datum/subclass/proc/post_equip(mob/living/carbon/human/H)
...
/*
	...
	On the datum! Wow!
*/
/datum/subclass/proc/check_requirements(mob/living/carbon/human/H)
...
/datum/subclass/proc/boost_by_plus_power(plus_factor, mob/living/carbon/human/H)
