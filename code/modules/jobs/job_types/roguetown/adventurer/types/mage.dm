...
/datum/outfit/job/roguetown/adventurer/mage/pre_equip(mob/living/carbon/human/H)
	...
	if(H.mind)
		...
		H.adjust_skillrank(/datum/skill/combat/wrestling, pick(0,1,2), TRUE)
		H.adjust_skillrank(/datum/skill/combat/unarmed, pick(0,1,2), TRUE)
		H.adjust_skillrank(/datum/skill/misc/swimming, 1, TRUE)
		H.adjust_skillrank(/datum/skill/misc/climbing, pick(0,1), TRUE)
		H.adjust_skillrank(/datum/skill/misc/athletics, 2, TRUE)
		H.adjust_skillrank(/datum/skill/combat/swords, pick(0,1), TRUE)
		H.adjust_skillrank(/datum/skill/combat/knives, pick(0,1,2), TRUE)
