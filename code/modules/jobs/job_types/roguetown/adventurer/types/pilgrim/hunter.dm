...
/datum/outfit/job/roguetown/adventurer/hunter/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/flint = 1, /obj/item/bait = 1, /obj/item/rogueweapon/shovel/small=1, /obj/item/cooking/pan = 1)
	...
	if(H.mind)
		...
		H.mind.adjust_skillrank(/datum/skill/combat/bows, pick(3,4,4), TRUE) //DAMN YOU NEOOOOON !!!
