...
/datum/outfit/job/roguetown/adventurer/farmermaster/pre_equip(mob/living/carbon/human/H)
	...
	if(H.gender == FEMALE)
		...
		pants = null
	backpack_contents = list(/obj/item/seeds/wheat = 1,/obj/item/seeds/cabbage = 1,/obj/item/seeds/cherry = 1,/obj/item/seeds/olive = 1,/obj/item/seeds/tomato = 1,/obj/item/seeds/onion = 1,/obj/item/seeds/garlic = 1,/obj/item/seeds/potato = 1,/obj/item/seeds/eggplant = 1,/obj/item/seeds/bean = 1,/obj/item/seeds/radish = 1,/obj/item/seeds/beet = 1,/obj/item/seeds/bellpepper = 1,/obj/item/seeds/rice = 1,/obj/item/seeds/cucumber = 1,/obj/item/seeds/tea = 1,/obj/item/seeds/mycelium/plumphelmet = 1)
