...
/datum/outfit/job/roguetown/adventurer/sfighter/pre_equip(mob/living/carbon/human/H)
	...
	switch(classchoice)
		...
		if("Warrior")
			...
			H.adjust_skillrank(/datum/skill/combat/crossbows, rand(1,2), TRUE)
			H.adjust_skillrank(/datum/skill/combat/polearms, 4, TRUE)
			H.adjust_skillrank(/datum/skill/combat/maces, 3, TRUE)
			H.adjust_skillrank(/datum/skill/combat/axes, 3, TRUE)
			H.adjust_skillrank(/datum/skill/combat/bows, rand(1,2), TRUE)
			...
			H.adjust_skillrank(/datum/skill/misc/sneaking, pick(1,1,2), TRUE)
			H.adjust_skillrank(/datum/skill/misc/swimming, 1, TRUE)
			H.adjust_skillrank(/datum/skill/misc/climbing, 2, TRUE)
			H.adjust_skillrank(/datum/skill/misc/riding, pick(2,3), TRUE)
		...
		if("Monster Hunter")
			...
			H.adjust_skillrank(/datum/skill/combat/crossbows, rand(3,4), TRUE)
			H.adjust_skillrank(/datum/skill/combat/bows, rand(3,4), TRUE)
