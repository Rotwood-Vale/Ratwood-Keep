...
/datum/outfit/job/roguetown/monk
	...
	allowed_patrons = list(/datum/patron/divine/pestra, /datum/patron/divine/astrata, /datum/patron/divine/eora /datum/patron/divine/noc) //Eora content from Stonekeep
