...
/mob/living/carbon/human/proc/coronate_lord()
	...
	for(var/mob/living/carbon/human/HU in get_step(src, src.dir))
		...
		src.log_message("has coronated [key_name(HU)] the new ruler of Rockhill. (PRIEST)", LOG_GAME)
...
/mob/living/carbon/human/proc/churchexcommunicate()
	...
	if(inputty)
		...
		if(inputty in GLOB.excommunicated_players)
			...
			src.log_message("has removed heretic status from [inputty]. (PRIEST)", LOG_GAME)
			return
		var/found = FALSE
		for(var/mob/living/carbon/human/H in GLOB.player_list)
			if(H == src)
		...
		src.log_message("has declared [inputty] a heretic. (PRIEST)", LOG_GAME)
...
/mob/living/carbon/human/proc/churchannouncement()
	...
	src.log_message("makes an announcement: \"[inputty]\". (PRIEST)", LOG_GAME)
