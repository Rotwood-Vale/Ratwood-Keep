...
/datum/outfit/job/roguetown/bogguardsman/proc/assign_skills(mob/living/carbon/human/bogger)
	bogger.adjust_skillrank(/datum/skill/combat/wrestling, 4, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/unarmed, 4, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/maces, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/polearms, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/whipsflails, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/knives, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/bows, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/crossbows, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/athletics, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/climbing, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/sneaking, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/swimming, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/medicine, 1, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/riding, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/reading, 1, TRUE)
...
/datum/outfit/job/roguetown/ranger/proc/assign_skills(mob/living/carbon/human/bogger)
	bogger.adjust_skillrank(/datum/skill/combat/crossbows, 4, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/bows, 4, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/knives, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/wrestling, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/unarmed, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/swords, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/combat/maces, 1, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/sneaking, 4, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/athletics, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/climbing, 3, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/swimming, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/medicine, 1, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/riding, 2, TRUE)
	bogger.adjust_skillrank(/datum/skill/misc/reading, 1, TRUE)
