...
/datum/outfit/job/roguetown/citywatch/proc/assign_skills(mob/living/carbon/human/guard)
	guard.adjust_skillrank(/datum/skill/combat/maces, pick(3,4), TRUE)
	guard.adjust_skillrank(/datum/skill/combat/wrestling, 4, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/unarmed, 4, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/swords, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/polearms, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/whipsflails, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/knives, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/bows, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/combat/crossbows, 2, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/climbing, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/athletics, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/sneaking, 3, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/swimming, 2, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/reading, 1, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/medicine, 1, TRUE)
	guard.adjust_skillrank(/datum/skill/misc/riding, 2, TRUE)
