...
/datum/outfit/job/roguetown/manorguard/veteran/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/rogueweapon/huntingknife/idagger/steel/rondel = 1, /obj/item/rope/chain = 1, /obj/item/storage/keyring/man_at_arms = 1, /obj/item/signal_horn = 1, /obj/item/natural/cloth = 1)
	if(H.mind)
