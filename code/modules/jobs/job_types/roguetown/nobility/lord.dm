...
/datum/job/roguetown/lord
	...
	tutorial = "Entrika ve siyasi kargaşa ağıyla tahtına yükselmiş olan sen, bu toprakların mutlak otoritesisin ve buradaki her komplonun merkezindesin. Her erkek, kadın ve çocuk senin konumuna gıpta ediyor ve seni göz açıp kapayıncaya kadar yerinden etmek istiyor: Onlara doğru yolu göster."
	whitelist_req = FALSE
	min_pq = 10
	max_pq = null
