...
/datum/outfit/job/roguetown/farmer/pre_equip(mob/living/carbon/human/H)
	..()
	if(H.mind)
		H.mind.adjust_skillrank(/datum/skill/combat/whipsflails, 3, TRUE) //just some more things to make people play soilson
		H.mind.adjust_skillrank(/datum/skill/combat/wrestling, 4, TRUE) //dont fuck with the guy who toils the field all day
