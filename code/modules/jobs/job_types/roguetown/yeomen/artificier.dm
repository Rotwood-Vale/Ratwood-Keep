...
/datum/outfit/job/roguetown/artificer/pre_equip(mob/living/carbon/human/H)
	...
	H.adjust_skillrank(/datum/skill/combat/firearms, 3, TRUE)	//artificer is primary produce of both fire arms and crossbows. Thus, journeyman (All combat roles primarily have expert crossbow and bows)
