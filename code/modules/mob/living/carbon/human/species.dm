...
//	var/armor_block = H.run_armor_check(affecting, "melee", span_notice("My armor has protected my [hit_area]!"), span_warning("My armor has softened a hit to my [hit_area]!"),pen)
