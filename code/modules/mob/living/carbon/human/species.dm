...
//				H.apply_status_effect(/datum/status_effect/debuff/fat)
		...
		if(NUTRITION_LEVEL_FED to NUTRITION_LEVEL_FAT)
			H.remove_stress_list(list(/datum/stressevent/peckish,/datum/stressevent/stuffed,/datum/stressevent/hungry,/datum/stressevent/starving))
			H.apply_status_effect(/datum/status_effect/debuff/hungryt0)
		...
		if(NUTRITION_LEVEL_STARVING to NUTRITION_LEVEL_HUNGRY)
			...
			if(prob(1.5))
				playsound(get_turf(H), pick('sound/vo/hungry1.ogg','sound/vo/hungry2.ogg','sound/vo/hungry3.ogg'), 50, TRUE, -1)
...
//			H.apply_status_effect(/datum/status_effect/debuff/waterlogged)
		if(HYDRATION_LEVEL_SLIGHTTHIRST to HYDRATION_LEVEL_FULL)
			H.remove_stress_list(list(/datum/stressevent/drym,/datum/stressevent/thirst,/datum/stressevent/parched))
		if(HYDRATION_LEVEL_SMALLTHIRST to HYDRATION_LEVEL_SLIGHTTHIRST)
			H.remove_stress_list(list(/datum/stressevent/drym,/datum/stressevent/thirst,/datum/stressevent/parched))
			H.apply_status_effect(/datum/status_effect/debuff/thirstyt0)
