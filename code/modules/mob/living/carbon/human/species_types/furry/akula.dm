...
/datum/species/akula/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	..()
	//RegisterSignal(C, COMSIG_MOB_SAY, PROC_REF(handle_speech)) //Vrell - idk if this is needed but i'm not adding more than I know I need to.

	var/mob/living/carbon/human/species/akula/H = C
	if(H.age == AGE_YOUNG)
		offset_features = list(OFFSET_ID = list(0,-1), OFFSET_GLOVES = list(0,-1), OFFSET_WRISTS = list(0,-1),\
		OFFSET_CLOAK = list(0,-1), OFFSET_FACEMASK = list(0,-1), OFFSET_HEAD = list(0,-1), \
		OFFSET_FACE = list(0,-1), OFFSET_BELT = list(0,-1), OFFSET_BACK = list(0,-11), \
		OFFSET_NECK = list(0,-1), OFFSET_MOUTH = list(0,-1), OFFSET_PANTS = list(0,-1), \
		OFFSET_SHIRT = list(0,-1), OFFSET_ARMOR = list(0,-1), OFFSET_HANDS = list(0,-1), OFFSET_UNDIES = list(0,-1), \
		OFFSET_ID_F = list(0,-3), OFFSET_GLOVES_F = list(0,-2), OFFSET_WRISTS_F = list(0,-2), OFFSET_HANDS_F = list(0,-2), \
		OFFSET_CLOAK_F = list(0,-2), OFFSET_FACEMASK_F = list(0,-3), OFFSET_HEAD_F = list(0,-3), \
		OFFSET_FACE_F = list(0,-3), OFFSET_BELT_F = list(0,-3), OFFSET_BACK_F = list(0,-3), \
		...
		limbs_icon_m = 'icons/mob/species/male_young.dmi'
		limbs_icon_f = 'icons/mob/species/female_young.dmi'
