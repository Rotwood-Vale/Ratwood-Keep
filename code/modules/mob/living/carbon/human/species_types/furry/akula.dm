...
/datum/species/akula
	...
	specstats = list("strength" = 0, "perception" = -2, "intelligence" = -1, "constitution" = 1, "endurance" = 2, "speed" = 1, "fortune" = 0)
	specstats_f = list("strength" = -1, "perception" = -2, "intelligence" = 0, "constitution" = 1, "endurance" = 2, "speed" = 1, "fortune" = 0)
