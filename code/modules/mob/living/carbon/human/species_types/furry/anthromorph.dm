...
/datum/species/anthromorph
	...
	specstats = list("strength" = 0, "perception" = -2, "intelligence" = 1, "constitution" = 2, "endurance" = -1, "speed" = 0, "fortune" = 1)
	specstats_f = list("strength" = -1, "perception" = -2, "intelligence" = 2, "constitution" = 2, "endurance" = -1, "speed" = 0, "fortune" = 1)
