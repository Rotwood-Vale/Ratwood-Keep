...
/datum/species/demihuman/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	...
	var/mob/living/carbon/human/species/demihuman/H = C
	if(H.age == AGE_YOUNG)
		...
		//VRELL - debated removing this but given that we are stuck with bodyhair otherwise, i'm leaving it.
		hairyness = null

//		soundpack_m = new /datum/voicepack/male/young()
		//VRELL - furries might need beards for their colors even as young adults
		//H.has_stubble = TRUE 
