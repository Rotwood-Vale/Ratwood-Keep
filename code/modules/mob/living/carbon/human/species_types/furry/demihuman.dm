...
/datum/species/demihuman
	...
	specstats = list("strength" = 0, "perception" = -1, "intelligence" = 2, "constitution" = 0, "endurance" = 2, "speed" = 0, "fortune" = -1) 
	specstats_f = list("strength" = 0, "perception" = 0, "intelligence" = 2, "constitution" = 0, "endurance" = 1, "speed" = 0, "fortune" = -1) 
