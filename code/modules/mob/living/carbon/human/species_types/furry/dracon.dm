...
/datum/species/dracon
	...
	inherent_traits = list(TRAIT_NOMOBSWAP, TRAIT_LEAPER)
	...
	specstats = list("strength" = 1, "perception" = 0, "intelligence" = -1, "constitution" = 1, "endurance" = 1, "speed" = 0, "fortune" = 0)
	specstats_f = list("strength" = 1, "perception" = 0, "intelligence" = -1, "constitution" = 1, "endurance" = 1, "speed" = 0, "fortune" = 0)
