...
/datum/species/dracon
	...
	specstats = list("strength" = 1, "perception" = 0, "intelligence" = 1, "constitution" = -1, "endurance" = 1, "speed" = -1, "fortune" = 0)
	specstats_f = list("strength" = 1, "perception" = 0, "intelligence" = 1, "constitution" = -1, "endurance" = 1, "speed" = -1, "fortune" = 0)
