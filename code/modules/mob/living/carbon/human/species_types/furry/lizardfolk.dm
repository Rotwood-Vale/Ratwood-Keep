...
/datum/species/lizardfolk
	...
	specstats = list("strength" = 2, "perception" = -1, "intelligence" = -1, "constitution" = 1, "endurance" = 0, "speed" = 0, "fortune" = 0)
	specstats_f = list("strength" = 1, "perception" = -1, "intelligence" = 0, "constitution" = 1, "endurance" = 0, "speed" = 0, "fortune" = 0)
