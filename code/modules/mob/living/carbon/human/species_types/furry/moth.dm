...
/datum/species/moth
	...
	limbs_icon_m_short = 'icons/mob/species/moth_male_short.dmi'
	limbs_icon_f_short = 'icons/mob/species/moth_female_short.dmi'
	...
	offset_features_short = list(
		OFFSET_ID = list(0,-2), OFFSET_GLOVES = list(0,-2), OFFSET_WRISTS = list(0,-2),\
