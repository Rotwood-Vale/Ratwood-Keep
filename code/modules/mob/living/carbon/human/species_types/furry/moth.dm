...
/datum/species/moth
	...
	specstats = list("strength" = -2, "perception" = 1, "intelligence" = 2, "constitution" = -1, "endurance" = 0, "speed" = 1, "fortune" = 0)
	specstats_f = list("strength" = -3, "perception" = 1, "intelligence" = 3, "constitution" = -1, "endurance" = 0, "speed" = 1, "fortune" = 0)
