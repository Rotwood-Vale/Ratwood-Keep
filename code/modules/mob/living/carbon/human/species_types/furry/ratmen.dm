...
/datum/species/ratpeople
	...
	specstats = list("strength" = -1, "perception" = 1, "intelligence" = -1, "constitution" = 0, "endurance" = 0, "speed" = 2, "fortune" = -1)
	specstats_f = list("strength" = -2, "perception" = 1, "intelligence" = 0, "constitution" = -1, "endurance" = 0, "speed" = 3, "fortune" = -1)
