...
/datum/species/tabaxi
	...
	specstats = list("strength" = -1, "perception" = 2, "intelligence" = 0, "constitution" = -2, "endurance" = 1, "speed" = 1, "fortune" = 0)
	specstats_f = list("strength" = -2, "perception" = 2, "intelligence" = 1, "constitution" = -2, "endurance" = 1, "speed" = 1, "fortune" = 0)
