...
/datum/species/tabaxi
	...
	specstats = list("strength" = 0, "perception" = 1, "intelligence" = 0, "constitution" = -1, "endurance" = 0, "speed" = 1, "fortune" = 1)
	specstats_f = list("strength" = 0, "perception" = 1, "intelligence" = 0, "constitution" = -1, "endurance" = 0, "speed" = 1, "fortune" = 1)
