...
/datum/species/vulpkanin
	...
	specstats = list("strength" = 1, "perception" = -2, "intelligence" = 0, "constitution" = 1, "endurance" = 2, "speed" = 0, "fortune" = -1)
	specstats_f = list("strength" = 0, "perception" = -2, "intelligence" = 1, "constitution" = 1, "endurance" = 2, "speed" = 0, "fortune" = -1)
