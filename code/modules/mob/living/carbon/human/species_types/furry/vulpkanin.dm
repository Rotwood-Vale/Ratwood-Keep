...
/datum/species/vulpkanin
	...
	limbs_icon_m = 'icons/mob/species/anthro_male.dmi'
	limbs_icon_f = 'icons/mob/species/anthro_female.dmi'
	limbs_icon_m_short = 'icons/mob/species/anthro_male_short.dmi'
	limbs_icon_f_short = 'icons/mob/species/anthro_female_short.dmi'
	...
	offset_features_short = list(OFFSET_ID = list(0,-1), OFFSET_GLOVES = list(0,-1), OFFSET_WRISTS = list(0,-1),\
		OFFSET_CLOAK = list(0,-1), OFFSET_FACEMASK = list(0,-1), OFFSET_HEAD = list(0,-1), \
		OFFSET_FACE = list(0,-1), OFFSET_BELT = list(0,-1), OFFSET_BACK = list(0,-1), \
		OFFSET_NECK = list(0,-1), OFFSET_MOUTH = list(0,-1), OFFSET_PANTS = list(0,-1), \
		OFFSET_SHIRT = list(0,-1), OFFSET_ARMOR = list(0,-1), OFFSET_HANDS = list(0,-1), OFFSET_UNDIES = list(0,-1), \
