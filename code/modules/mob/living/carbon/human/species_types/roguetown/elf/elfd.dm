...
*/
	...
	limbs_icon_m = 'icons/mob/species/elfd_male.dmi'
	limbs_icon_f = 'icons/mob/species/humen_female.dmi'
	limbs_icon_m_short = 'icons/mob/species/elfd_male_short.dmi'
	limbs_icon_f_short = 'icons/mob/species/humen_female_short.dmi'
	...
	offset_features_short = list(
		OFFSET_ID = list(0,-2), OFFSET_GLOVES = list(0,-1), OFFSET_WRISTS = list(0,-1),\
