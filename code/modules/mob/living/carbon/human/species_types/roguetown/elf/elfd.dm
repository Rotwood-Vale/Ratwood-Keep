...
*/
	...
	specstats = list("strength" = -1, "perception" = 1, "intelligence" = 0, "constitution" = 1, "endurance" = -2, "speed" = 2, "fortune" = 0)
	specstats_f = list("strength" = 0, "perception" = 1, "intelligence" = 1, "constitution" = 1, "endurance" = -2, "speed" = 2, "fortune" = 0)
