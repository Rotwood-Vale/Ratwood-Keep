...
/datum/species/aasimar
	...
	specstats = list("strength" = 0, "perception" = 0, "intelligence" = 2, "constitution" = -2, "endurance" = 0, "speed" = 0, "fortune" = 2)
	specstats_f = list("strength" = 0, "perception" = 0, "intelligence" = 2, "constitution" = -2, "endurance" = 0, "speed" = 0, "fortune" = 2)
