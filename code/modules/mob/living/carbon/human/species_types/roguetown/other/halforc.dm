...
/datum/species/halforc
	...
	inherent_traits = list(TRAIT_NOMOBSWAP, TRAIT_BREADY)
    ...
    specstats = list("strength" = 2, "perception" = -1, "intelligence" = -1, "constitution" = 2, "endurance" = 2, "speed" = -1, "fortune" = -1)
    specstats_f = list("strength" = 2, "perception" = -1, "intelligence" = -1, "constitution" = 2, "endurance" = 2, "speed" = -1, "fortune" = -1)
