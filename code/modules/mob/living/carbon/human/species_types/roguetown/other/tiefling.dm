...
/datum/species/tieberian
	...
	inherent_traits = list(TRAIT_NOMOBSWAP, TRAIT_ANTIMAGIC)
	...
	specstats = list("strength" = 0, "perception" = 1, "intelligence" = 1, "constitution" = -1, "endurance" = 0, "speed" = 0, "fortune" = -1)
	specstats_f = list("strength" = 0, "perception" = 1, "intelligence" = 1, "constitution" = -1, "endurance" = 0, "speed" = 0, "fortune" = -1)
