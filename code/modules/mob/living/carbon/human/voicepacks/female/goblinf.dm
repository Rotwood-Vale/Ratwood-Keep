/datum/voicepack/female/goblinf/get_sound(soundin, modifiers)
	var/used
	switch(modifiers)
		if("old")
	...
	if(!used)
		switch(soundin)
			if("laugh")
				used = pick('sound/vo/female/gob/laugh (1).ogg','sound/vo/female/gob/laugh (2).ogg','sound/vo/female/gob/laugh (3).ogg')
			if("aggro")
