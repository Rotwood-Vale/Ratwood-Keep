/datum/voicepack/female/get_sound(soundin, modifiers)
	...
	if(!used)
		switch(soundin)
			...
			if("conqrah")
				used = 'sound/vo/female/gen/femconqrah.ogg'
			if("huh")
			...
			if("catrage")
				used = list('sound/vo/scream_cat.ogg')
			if("bark")
				used = list('sound/vo/bark1.ogg', 'sound/vo/bark2.ogg')
			if("whine")
				used = list('sound/vo/whine.ogg')
			if("cackle")
				used = list('sound/vo/cackle.ogg')
			if("blink")
