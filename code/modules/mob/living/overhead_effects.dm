...
/mob/living/proc/play_stress_indicator()
	play_overhead_indicator('icons/mob/overhead_effects.dmi', "stress", 10, OBJ_LAYER)
	playsound(src, 'sound/ddstress.ogg', 100, FALSE, ignore_walls = FALSE)

/mob/living/proc/play_relief_indicator()
	play_overhead_indicator('icons/mob/overhead_effects.dmi', "relief", 10, OBJ_LAYER)
	playsound(src, 'sound/ddrelief.ogg', 100, FALSE, ignore_walls = FALSE)
