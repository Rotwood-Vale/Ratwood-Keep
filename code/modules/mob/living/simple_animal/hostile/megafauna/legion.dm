...
/datum/action/innate/megafauna_attack/create_skull
	...
	chosen_message = span_colossus("I are now creating legion skulls.")
	chosen_attack_num = 1
...
/datum/action/innate/megafauna_attack/charge_target
	...
	chosen_message = span_colossus("I are now charging at your target.")
	chosen_attack_num = 2
...
/obj/structure/legionturret
	...
	armor = list("blunt" = 0, "slash" = 0, "stab" = 0, "bullet" = 0, "laser" = 100,"energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0)
