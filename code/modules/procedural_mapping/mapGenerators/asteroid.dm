...
/datum/mapGeneratorModule/splatterLayer/asteroidMonsters
	spawnableTurfs = list()
	spawnableAtoms = list(/mob/living/simple_animal/hostile/retaliate/rogue/asteroid/basilisk = 10, \
		/mob/living/simple_animal/hostile/retaliate/rogue/asteroid/hivelord = 10, \
		/mob/living/simple_animal/hostile/retaliate/rogue/asteroid/goliath = 10)
