...
/obj/structure/dye_bin/ui_interact(mob/user)
	...
	if(!inserted)
		...
		if(berry_charges <= 0)
			...
			dat += "<A href='byond://?src=\ref[src];select=1'>Mix a color.</A><BR>"
			dat += "Color: <font color='[activecolor]'>&#9899;</font>"
			dat += "<A href='byond://?src=\ref[src];paint=1'>Rub the dyes in.</A><BR><BR>"
			dat += "<A href='byond://?src=\ref[src];clear=1'>Bleach it.</A><BR><BR>"
