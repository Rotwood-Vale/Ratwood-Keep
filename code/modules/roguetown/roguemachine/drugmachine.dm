...
/obj/structure/roguemachine/drugmachine/Initialize()
	...
	held_items[/obj/item/reagent_containers/powder/ozium] = list("PRICE" = 25,"NAME" = "ozium")
	held_items[/obj/item/reagent_containers/powder/moondust] = list("PRICE" = 25,"NAME" = "moondust")
	held_items[/obj/item/clothing/mask/cigarette/rollie/nicotine] = list("PRICE" = 6,"NAME" = "zig")
	held_items[/obj/item/clothing/mask/cigarette/rollie/cannabis] = list("PRICE" = 18,"NAME" = "swampweed zig")
	held_items[/obj/item/clothing/mask/cigarette/rollie/shroom] = list("PRICE" = 25,"NAME" = "shroom zig")
	held_items[/obj/item/lighter/paf] = list("PRICE" = 150,"NAME" = "port-a-flame")
	held_items[/obj/item/storage/box/matches] = list("PRICE" = 45,"NAME" = "tinderbox")
	held_items[/obj/item/storage/fancy/cigarettes/cigars] = list("PRICE" = 50,"NAME" = "zig case (empty)")
