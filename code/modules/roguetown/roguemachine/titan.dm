	...
	switch(mode)
		if(0)
			if(findtext(message2recognize, "help"))
				say("My commands are: Make Decree, Invalidate Decrees, Make Announcement, Set Taxes, Declare Outlaw, Summon Crown, Summon Key, Change Position, Make Law, Remove Law, Purge Laws, Nevermind")
