...
/datum/crafting_recipe/roguetown/healinggas
	name = "Put poison and smoke payloads into a grenade shell"
	result = list(/obj/item/impact_grenade/poison_gas)
	reqs = list(/obj/item/paper/scroll = 1, /obj/item/natural/hide = 1, /obj/item/rogueore/coaldust = 3, /obj/item/rogueore/sulfur = 1, /obj/item/rogueore/selitre = 1, /datum/reagent/medicine/lesserhealthpot = 7.5)
	skillcraft = /datum/skill/misc/transmutation
	skill_level = 3
