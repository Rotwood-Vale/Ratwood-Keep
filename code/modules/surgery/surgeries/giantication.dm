...
/datum/surgery_step/giantication/success(mob/user, mob/living/target, target_zone, obj/item/tool, datum/intent/intent)
...
/datum/status_effect/gianted/on_remove() //WILL NOT MAKE THEM NORMAL!!!
	if(ishuman(owner))
		var/mob/living/carbon/human/H = owner
		H.mob_size -= 1
		H.change_stat("constitution", -2)
