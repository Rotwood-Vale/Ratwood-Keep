/obj/item/signal_horn
	...
	icon = 'modular/icons/obj/items/signalhorn.dmi'
...
/obj/item/signal_horn/proc/sound_horn(mob/living/user)
	...
	playsound(src, 'modular/sound/items/signalhorn.ogg', 100, TRUE)
	...
	for(var/mob/player in GLOB.player_list)
		...
		if(get_dist(player, src) > 7)
			player.playsound_local(get_turf(player), 'modular/sound/items/signalhorn.ogg', 35, FALSE, pressure_affected = FALSE)
