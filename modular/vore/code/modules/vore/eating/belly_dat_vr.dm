...
/datum/belly
	...
	var/vore_sound = 'modular/vore/sound/vore/pred/swallow_01.ogg'	// Sound when ingesting someone
...
//	var/silenced = FALSE					// Will the heartbeat/fleshy internal loop play?
	...
	var/tmp/list/digest_modes = list(DM_HOLD,DM_DIGEST,DM_NOISY)	// Possible digest modes
