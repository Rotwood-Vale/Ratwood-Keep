...
/datum/supply_pack/rogue/weapons/warhammers
	name = "3x Steel Warhammers"
	cost = 150 //3 steel
	contains = list(
...
/datum/supply_pack/rogue/weapons/warhammers/single
	name = "Steel Warhammer"
	cost = 60
	contains = list(/obj/item/rogueweapon/mace/warhammer/steel)

/datum/supply_pack/rogue/weapons/rapier
	name = "3x Rapiers"
	cost = 90 //3 steel
	contains = list(
...
/datum/supply_pack/rogue/weapons/rapier/single
	name = "Steel Rapier"
	cost = 35
	contains = list(/obj/item/rogueweapon/sword/rapier)

/datum/supply_pack/rogue/weapons/sabre
	name = "3x Sabres"
	cost = 90 //3 steel
	contains = list(
...
/datum/supply_pack/rogue/weapons/sabre/single
	name = "Steel Rapier"
	cost = 35
	contains = list(/obj/item/rogueweapon/sword/sabre)

/datum/supply_pack/rogue/weapons/longsw
	name = "3x Bastard Swords"
	cost = 150 //3 steel
	contains = list(
...
/datum/supply_pack/rogue/weapons/longsw/single
	name = "Bastard Sword"
	cost = 50
	contains = list(/obj/item/rogueweapon/sword/long)
			
/datum/supply_pack/rogue/weapons/ridersw
	name = "3x Scimitars"
	cost = 160 //3 steel
	contains = list(
