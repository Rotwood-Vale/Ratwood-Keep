/datum/subclass/steppesman
	ru_name = "Steppesman"
	ru_tutorial = "Once serving a Hetmen from the frontiers, you have been rented out as a mercenary in the distant realms to bring coin home. There are three things you value most; saigas, freedom, and coin."
...
/datum/outfit/job/roguetown/mercenary/steppesman/pre_equip(mob/living/carbon/human/H)
	...
	backpack_contents = list(/obj/item/storage/keyring/mercenary, /obj/item/rogueweapon/whip)
	if(H.mind)
